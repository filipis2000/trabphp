...
<body>
	<div class="container">
		...
		<button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal"
			data-bs-target="#cadastrar">Adicionar</button>
						...
						<form method="POST" action="processos/processa-cadastra-tarefa.php">
							...
							<div class="row">
								<div class="col-md">
									...
									<textarea class="form-control form-control-sm" rows="5" placeholder="Descreva aqui a tarefa."
										required="" name="tarefa"></textarea>
								</div>
							</div>
					</div>
